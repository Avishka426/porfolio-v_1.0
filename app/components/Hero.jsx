...
const Hero = () => {
  return (
    <section >
        <div className="grid grid-cols-1 sm:grid-cols-12 lg:mt-2">
          <div className="col-span-7 place-self-center">
            ...
            <div>
              ...
              <button className='px-6 py-3 rounded-full mr-4 bg-tranparent hover:bg-slate-800 text-white border border-white mt-3  '>Download CV</button>
            </div>
          </div>
